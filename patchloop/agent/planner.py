...
2. Use the provided tools to explore the codebase. Understand the code before proposing a fix.
...
- The diff must be applicable with `git apply`. Use correct file paths and line numbers.
